    ...
    <PageBody>
        ...
        <Row wrap useAppMargin>
          ...
          {loading ? (
            ...
            <Column xs={2} md={2} lg={1} style={{ marginRight: '20px'}}>
               <Text size={65} style={{ lineHeight: '65px'}} weight={500}>{data?.result.length}</Text>
             </Column>
      ...
      <Row useAppMargin>
        ...
        {data?.result.map((item:any) => (
          <Column
          useAppMargin md={6} lg={3} fullHeight>
            ...
            >
              <SizedBox height={2} />
              <Text casing="sentenceCase" size={18} weight={500} color={Colors.lightGreen}>
                {item.name}
              </Text>
              <SizedBox height={8} />
            ...
            <Row 
              style={{
                ...
                borderRadius: '2px 2px 0px 0px',
                padding: '5px 20px',
                background: 'linear-gradient(130.24deg, #006848 0%, #B4C404 100%)'
              }}
            ></Row>
          </Column>
        ))}
